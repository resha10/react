...
//   if (isAuthenticated) nav(from);

//   return (
//     <div className="container mt-4" style={{ maxWidth: 420 }}>
//       <h3 className="mb-3">Sign in</h3>
//       <div className="alert alert-secondary p-2">Demo login: <b>admin / admin</b></div>
//       <form onSubmit={submit}>
//         <input className="form-control mb-3" placeholder="Username" value={username} onChange={e => setU(e.target.value)} />
//         <input className="form-control mb-3" type="password" placeholder="Password" value={password} onChange={e => setP(e.target.value)} />
