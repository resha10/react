  ...
  const dashboardItems = [
    {
      ...
      description: "Stay updated with all your important Blog messages.",
    ...
    },
    {
      ...
      title: "Join with Resha Blog",
      description: "Be a part of our strong Resha Blog community.",
      bg: "linear-gradient(135deg, #00B09B, #96C93D)",
    },
    {
      icon: <FaSearch size={40} color="#fff" />,
      title: "Search Resha Directory",
      description: "Find your peers and seniors in the Resha directory.",
  ...
  return (
    <>
      ...
      <Navbar expand="lg" className="py-3 shadow-sm" style={{ background: "#fff" }}>
        ...
        >
          ...
          <Nav className="align-items-center gap-4">
            {["PRODUCTS", "FEATURES", "RESOURCES", "PRICING", "CONTACT US"].map(
              (item, i) => (
                <Nav.Link
                  key={i}
                  as={Link}
      ...
      <Container className="text-center my-5" style={{ maxWidth: "1250px" }}>
        <h2 className="fw-bold mb-3"> Resha Blog Dashboard</h2>
        <div
          style={{
            width: "80px",
            height: "4px",
